...
def create_employee(request):
    ...
    employee1 = Employee.objects.get_or_create(name="Rakesh",dept=it_dept,job_title="Developer",salary=100000.00,bonus=5000.00)[0]
    employee2 = Employee.objects.get_or_create(name="Keerthi",dept=hr_dept,job_title="HR manager",salary=90000.00,bonus=4000.00)[0]
...
def filter_employees_by_department(request):
    it_employees = Employee.objects.filter(dept__name="IT")
